...
class OnPolicyActorBuffer_Potential:
    ...
    def feed_forward_generator_actor(
        ...
        #print("debug, potential_actor_generator_actor active")
        ...
        for indices in sampler:
            ...
            time_indices = indices // n_rollout_threads
            thread_indices = indices % n_rollout_threads
            next_obs_batch = self.obs[time_indices + 1, thread_indices]
            if self.available_actions is not None:
            ...
            if self.factor is None:
                yield obs_batch, next_obs_batch, rnn_states_batch, actions_batch, masks_batch, active_masks_batch, old_action_log_probs_batch, adv_targ, available_actions_batch
            else:
